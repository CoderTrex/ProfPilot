...
class _LectureGeneratePageState extends State<LectureGeneratePage> {
  ...
  final TextEditingController LectureStartTimeController =
      TextEditingController();
  final TextEditingController LectureEndTimeController =
      TextEditingController();
  ...
  Future<void> _SendLectureData() async {
    ...
    final String Room = RoomController.text;
                  ...
                  onPressed: () async {
                    ...
                    if (time != null) {
                      setState(() {
                        ...
                        LectureStartTimeController.text =
                            '${selectedStartTime!.hour}:${selectedStartTime!.minute}';
                      });
                    }
                  },
