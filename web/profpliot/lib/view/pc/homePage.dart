...
import 'package:profpliot/screen/pc/attendancePage.dart';
  ...
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) {
      if (index == 1) {
        ...
        return PcHomePage(); // You can replace this with the appropriate widget for the default case.
      }
    },
...
class _homepage extends State<PcHomePage>
    with AutomaticKeepAliveClientMixin<PcHomePage> {
  @override
